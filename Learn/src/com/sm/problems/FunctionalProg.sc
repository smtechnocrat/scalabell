...
object FunctionalProg {
  ...
  val xs = List(1, 2, 3, 4, 5) match {
    case x :: 2 :: 4 :: _ :: Nil => x
    case Nil => 42
    case x :: y :: 3 :: 4 :: _ :: Nil => x + y
    case (h :: t) => h
    case _ => 101
  } //> xs  : Int = 3
  ...
  println(tail(List(3, 4, 5, 6))) //> List(4, 5)

   def fizzbuzz() = {
    for (i <- List.range(1, 100)) if (i % 3 == 0) println("Fizz")
    else if (i % 5 == 0) println("Buzz")
    else if (i % 15 == 0) println("FizzBuzz")
    else println(i)
  }
